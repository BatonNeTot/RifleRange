 ...
 *  size device supports presentation to the platform GLFW was built for.
 *
 ...
 *  required.
 *
 *  @param[in] instance The instance that the size device belongs to.
 *  @param[in] device The size device that the queue family belongs to.
